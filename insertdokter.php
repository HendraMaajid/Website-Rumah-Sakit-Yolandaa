<?php
    ...
    if(isset($_POST['insert'])){
        ...
        $sql = "INSERT INTO dokter (nama_dokter, tanggal_lahir, spesialis, no_hp, email, alamat, foto) VALUES ('$nama', '$tanggal_lahir', '$spesialis', '$no_hp', '$email', '$alamat','$upload')";
        $query = mysqli_query($conn, $sql);
        if($query){
                ?>
            <script>
                alert("Data dokter berhasil di tambahkan");
                location = "viewdokter_operator.php";
            </script>
            <?php
        }else{

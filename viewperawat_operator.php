    ...
    if(isset($_GET['id_delete'])){
        ...
        if($query){
            ...
            <script>
                ...
                document.location = "viewperawat_operator.php";
            </script>
            <?php
        }else{
            ?>
...
<body>
                ...
                <h1>Daftar Perawat</h1>
                 <div class="search-container">
                    <form id="searchForm" method="get" action="">
                        ...
                        <table class="tabeldata" id="perawatTable">
                            <tr>
                                ...
                                if(mysqli_num_rows($q) > 0){
                                    ...
                                    echo "<tr>";
                                    echo "<td colspan='4'>Tidak ada perawat yang terdaftar</td>";
                                    echo "</tr>";
                                }
                            ?>
                        </table>
                        <a href="insertperawat.php" ><button class="pesan" >Tambah Data</button></a>
            </div>
        </div>
        <div class="footer">
            <!-- nunggu homepage -->
    ...
    $(document).ready(function () {
        $('#search').on('input', function () {
            ...
            $.ajax({
                url: 'ajax/ajax_search_perawat.php',
                type: 'GET',
                ...
                success: function (data) {
                    ...
                    $('#perawatTable').html(tableWithHeaders);
                }
            });
        });
    });

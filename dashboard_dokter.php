                ...
                <div class="kotak-biodata">
                    <p class="sub-judul">
                        ...
                        <?php if ($_SESSION['role'] == 'dokter') {
                         echo "<a href='editdokter1.php?id=$row[id_dokter]'><span><button>Update Data</button></span></a>";
                        }
                        ?>
                    </p>
                        ...
                        <div class="kotak-data-bawah">
                            ...
                            <tr>
                                ...
                                $s = "SELECT dokter.nama_dokter, pasien.nama_pasien, konsultasi.*, pesan_kamar.*, ruang.*
                                    ...
                                    AND konsultasi.jam_konsultasi >= CURTIME()
                                ...
                                if(mysqli_num_rows($q) > 0){
                                    ...
                                    echo "<tr>";
                                    echo "<td colspan='4'>Tidak ada pasien yang akan konsultasi</td>";
                                    echo "</tr>";
                                }
                            ?>
                            </table>
                            <?php
                            if(mysqli_num_rows($q) > 0){
                                echo "<a class='view-all-pasien' href='viewpasien_dokter.php' >view all</a>";
                            }
                            ?>
                        </div>
                    </div>

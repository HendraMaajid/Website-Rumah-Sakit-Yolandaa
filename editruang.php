    ...
    if(isset($_POST['update'])){
        ...
        if($query){
            ...
            <script>
                ...
                location = "viewruang_operator.php";
            </script>
            <?php
        }
    }
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="isi_content">
                ...
                <h1>Tambah Ruang</h1>
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" style="width:450px;">
                    <label for="nama_ruang">Nama Ruang</label>
                    <br>
                    <input type="text" name="nama_ruang" id="nama_ruang"  style="width:350px;" value="<?php echo $row2['nama_ruang']; ?>">
                    <br>

                    <label for="jenis_ruang">Jenis Ruang</label>
                    <br>
                    <div class="custom-select" style="width:350px;">
                        <select name="jenis_ruang" id="jenis_ruang">
                        <option value="">Pilih Jenis Ruang</option>
                        <option value="Regular" <?php if($row2['jenis_ruang'] == 'Regular') echo 'selected="selected"'; ?>>Regular</option>
                        <option value="VIP" <?php if($row2['jenis_ruang'] == 'VIP') echo 'selected="selected"'; ?>>VIP</option>
                    </select>
                    </div>
                    <br>

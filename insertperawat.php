<?php
    ...
    if(isset($_POST['insert'])){
        ...
        $sql = "INSERT INTO perawat (nama_perawat, tanggal_lahir, no_hp, email, alamat, foto) VALUES ('$nama', '$tanggal_lahir', '$no_hp', '$email', '$alamat','$upload')";
        $query = mysqli_query($conn, $sql);
        if($query){
                ?>
            <script>
                alert("Data perawat berhasil di tambahkan");
                location = "viewperawat_operator.php";
            </script>
            <?php
        }else{

                    ...
                    <form id="searchForm" method="get" action="">
                        ...
                        <table class="tabeldata" id="pasienTable">
                            <tr>
                                ...
                                <th class="table-header">No KIS</th>
                                ...
                                if(mysqli_num_rows($q) > 0){
                                    ...
                                    echo "<tr>";
                                    echo "<td colspan='4'>Tidak ada pasien yang konsultasi</td>";
                                    echo "</tr>";
                                }
                            ?>
                        </table>
                        <a href="insertpasien.php" ><button class="pesan" >Tambah Data</button></a>
            </div>
        </div>
        <div class="footer">
            <!-- nunggu homepage -->
...
<script>
    $(document).ready(function () {
        $('#search').on('input', function () {
            ...
            $.ajax({
                url: 'ajax/ajax_search_pasien.php',
                type: 'GET',

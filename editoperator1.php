<?php
    ...
    if(isset($_POST['update'])){
        ...
        if ($foto != '') {
            ...
            $update="UPDATE staff_operator SET nama_operator = '$nama', tanggal_lahir='$tanggal_lahir', no_hp = '$no_hp', email = '$email', alamat = '$alamat', foto = '$upload' WHERE id_operator = '$id'";
            $query= mysqli_query($conn, $update);
        } else {
            $update="UPDATE staff_operator SET nama_operator = '$nama', tanggal_lahir='$tanggal_lahir', no_hp = '$no_hp', email = '$email', alamat = '$alamat' WHERE id_operator = '$id'";
            $query= mysqli_query($conn, $update);
        }
        //$sql = "UPDATE operator SET nama_operator='$nama', no_hp='$no_hp', email='$email', alamat='$alamat' WHERE id_operator='$id'";
        //$query = mysqli_query($conn, $sql);
        if($query){
            ?>
            <script>
                alert("Data operator berhasil di update");
                location = "dashboard_operator.php";
            </script>
            <?php
        }
    }
        ...
        <div class="content">
            ...
            <div class="isi_content">
                ...
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" id="nama" name="nama" value="<?php echo $row2['nama_operator']; ?>">

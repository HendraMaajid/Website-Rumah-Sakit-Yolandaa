            ...
            <div class="sidebar">
                ...
                <div class="bottom-sidebar">
                    <button>
                            ...
                            <a href="dashboard_owner.php">Profil</a>
                    </button>      
                    <button>  
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="kotak-biodata">
                    <p class="sub-judul">
                        ...
                        <?php if ($_SESSION['role'] == 'owner') {
                         echo "<a href='editowner.php?id=$row[id_owner]'><span><button>Update Data</button></span></a>";
                        }
                        ?>
                    </p>
                    ...
                    <div class="kotak-biodata-atas">
                     ...
                     <div class="kotak-biodata-bawah">
                        <div class="kotak-info">
                            ...
                            <p class="jumlah"> 
                                <span>
                                    <img src="image/medical-history.png" alt="pasien" width="70px" height="70px">
                                </span> 
                                <?php
                            ...
                            <p> Pasien terdaftar di Rumah Sakit Yolandaa</p>
                        </div>
                        <div class="kotak-info">
                            <h3>Dokter</h3>
                            <p class="jumlah"> 
                                <span>
                                    <img src="image/doctor.png" alt="dokter" width="70px" height="70px">
                                </span> 
                                <?php
                            ...
                            <p> Dokter terdaftar di Rumah Sakit Yolandaa</p>
                        </div>
                        <div class="kotak-info">
                            <h3>Perawat</h3>
                            <p class="jumlah">
                                 <span>
                                    <img src="image/iconnurse.png" alt="nurse" width="70px" height="70px">
                                 </span> 
                                 <?php
                            ...
                            <p> Perawat terdaftar di Rumah Sakit Yolandaa</p>
                        </div>
                        <div class="kotak-info">
                            <h3>Operator</h3>
                            <p class="jumlah">
                                 <span>
                                    <img src="image/admin.png" alt="operator" width="70px" height="70px">
                                 </span>
                                 <?php
                                    $sql = "SELECT * FROM staff_operator";
                                    $query = mysqli_query($conn, $sql);
                                    $jumlah = mysqli_num_rows($query);
                                    echo $jumlah;
                                ?>  

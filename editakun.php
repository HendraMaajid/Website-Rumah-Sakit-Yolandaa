<?php
    ...
    if(isset($_POST['update'])){
        ...
        $email = $_POST['email'];
        $no_id = $_POST['no_id'];
        $update="UPDATE akun SET username = '$username', password='$hashpassword', role = '$role', id='$no_id', email = '$email' WHERE username = '$id'";
        $query= mysqli_query($conn, $update);
        if($query){
            ?>
            <script>
                alert("Data akun berhasil di update");
                location = "viewakun.php";
            </script>
            <?php
        }
    }
        ...
        <div class="content">
            ...
            <div class="isi_content">
                ...
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <input id="email" name="email" type="email" value="<?php echo $row2['email']; ?>" required>
                    <br>

                    <label for="username">Username</label><br>
                    <input id="username" name="username" type="text" value="<?php echo $row2['username']; ?>" required>
                    <br>

                    <label for="no_id">ID Card/KIS</label><br>
                    <input id="no_id" name="no_id" type="number" value="<?php echo $row2['id']; ?>" required>
                    <br>
                    ...
                    <input id="role" name="role" type="text" value="<?php echo $row2['role']; ?>" >
                    <br>
                    <input type="submit" class="tambahberita" value="Update" name="update">
                </form>
            </div>
        </div>
        <div class="footer">

            ...
            <div class="isi_content">
                ...
                <div class="search-container">
                    <form id="searchForm" method="get" action="">
                        ...
                        <table class="tabeldata" id="pasienDokter">
                            <tr>
                                ...
                                <th class="table-header">Tanggal Konsultasi</th>
                            </tr>
                                <?php 
                                $now=date("Y-m-d");
                                $time=date("H:i:s");
...
<script>
    $(document).ready(function () {
        $('#search').on('input', function () {
            ...
            $.ajax({
                url: 'ajax/ajax_search_pasien_dokter.php',
                type: 'GET',
                ...
                success: function (data) {
                    ...
                    $('#pasienDokter').html(tableWithHeaders);
                }
            });
        });
    });

        ...
        <div class="content">
            ...
            <div class="isi_content">
                ...
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" style="width:450px;">
                    ...
                    <br>
                    <input type="text" name="nama_ruang" id="nama_ruang"  style="width:350px;">
                    <br>
                    ...
                    <div class="custom-select" style="width:350px;">
                        <select name="jenis_ruang" id="jenis_ruang">
                            <option value="0">pilih jenisnya</option>
                    ...
                    <input type="submit" name="insert" value="Insert" class="tambahberita">
                </form>
            </div>
        </div>
        <div class="footer">

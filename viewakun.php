            ...
            <div class="isi_content">
                ...
                <div class="search-container">
                    <form id="searchForm" method="get" action="">
                        ...
                        <table class="tabeldata" id="akunTable">
                            <tr>
                                ...
                                if(mysqli_num_rows($q) > 0){
                                    ...
                                    echo "<tr>";
                                    echo "<td colspan='4'>Tidak ada akun yang terdaftar</td>";
                                    echo "</tr>";
                                }
                            ?>
                        </table>
                        <a href="insertakun.php" ><button class="pesan" >Tambah Data</button></a>
            </div>
        </div>
        <div class="footer">
            <!-- nunggu homepage -->
        ...
        $('#search').on('input', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#akunTable').html(tableWithHeaders);
                }
            });
        });
    });

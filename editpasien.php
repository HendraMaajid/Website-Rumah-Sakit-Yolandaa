<?php
    ...
    if(isset($_POST['update'])){
        ...
        if ($foto != '') {
            ...
            $update="UPDATE pasien SET kis='$kis' ,nama_pasien='$nama', alamat='$alamat', tanggal_lahir='$tanggal_lahir', email='$email', no_hp='$no_hp', foto='$upload'  WHERE no_rekam_medis='$id'";
            $query= mysqli_query($conn, $update);
        } else {
            $update="UPDATE pasien SET kis='$kis' ,nama_pasien='$nama', alamat='$alamat', tanggal_lahir='$tanggal_lahir', email='$email', no_hp='$no_hp' WHERE no_rekam_medis='$id'";
            $query= mysqli_query($conn, $update);
        }
        if($query){
            ?>
        ...
        <div class="content">
            ...
            <div class="isi_content">
                ...
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" id="nama" name="nama" value="<?php echo $row2['nama_pasien']; ?>">

                    <label for="kis">Kis</label>
                    <input type="number" id="kis" name="kis" value="<?php echo $row2['kis']; ?>">
                    ...
                    <input type="text" id="no_hp" name="no_hp" value="<?php echo $row2['no_hp']; ?>">

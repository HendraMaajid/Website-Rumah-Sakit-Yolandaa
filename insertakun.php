<?php
    ...
    if(isset($_POST['insert'])){
        //buatkan untuk formnya pengambilan data sampai insert ke database
        $email = $_POST['email'];
        ...
        $role = $_POST['role'];
        $sql = "INSERT INTO akun (username, email, password, id, role) VALUES ('$username', '$email', '$hashpassword', '$id', '$role')";
        $query = mysqli_query($conn, $sql);

        if($query){
            ?>
            <script>
                alert("Anda berhasil menambahkan akun");
        ...
        <div class="content">
            ...
            <div class="isi_content">
                ...
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <label for="id">ID Card/KIS</label><br>
                    ...
                    <br>
                    <input type="submit" class="tambahberita" value="Insert" name="insert">
                </form>
            </div>
        </div>
        <div class="footer">

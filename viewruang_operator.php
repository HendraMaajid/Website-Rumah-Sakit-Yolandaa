    ...
    if(isset($_GET['id_delete'])){
        ...
        if($query){
            ...
            <script>
                ...
                document.location = "viewruang_operator.php";
            </script>
            <?php
        }else{
            ?>
...
<body>
            ...
            <div class="isi_content">
                ...
                <div class="search-container">
                    <form id="searchForm" method="get" action="">
                        ...
                        <table class="tabeldata" id="ruangTable">
                            <tr>
                                <th class="table-header">Nama Ruang</th>
                                ...
                                if(mysqli_num_rows($q) > 0){
                                    ...
                                    echo "<tr>";
                                    echo "<td colspan='4'>Tidak ada ruang yang terdaftar</td>";
                                    echo "</tr>";
                                }
                            ?>
                        </table>
                        <a href="insertruang.php" ><button class="pesan" >Tambah Data</button></a>
            </div>
        </div>
        <div class="footer">
            <!-- nunggu homepage -->
    ...
    $(document).ready(function () {
        $('#search').on('input', function () {
            ...
            $.ajax({
                url: 'ajax/ajax_search_ruang.php',
                type: 'GET',
                ...
                success: function (data) {
                    ...
                    $('#ruangTable').html(tableWithHeaders);
                }
            });
        });
    });

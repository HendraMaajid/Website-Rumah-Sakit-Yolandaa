<?php
    ...
    $sql = "SELECT * FROM staff_operator WHERE username = '$username'";
            ...
            <div class="sidebar">
                ...
                <div class="bottom-sidebar">
                    <button>
                            ...
                            <a href="dashboard_operator.php">Profil</a>
                    </button>      
                    <button>  
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="kotak-biodata">
                    <p class="sub-judul">
                        ...
                        <?php if ($_SESSION['role'] == 'operator') {
                         echo "<a href='editoperator1.php?id=$row[id_operator]'><span><button>Update Data</button></span></a>";
                        }
                        ?>
                    </p>
                    <div class="kotak-biodata-atas">
                     ...
                     <div class="kotak-biodata-bawah">
                        <div class="kotak-data-bawah">
                            <h3>Daftar Pasien Konsultasi</h3>
                            ...
                            <tr>
                                ...
                                if(mysqli_num_rows($q) > 0){
                                    ...
                                    echo "<tr>";
                                    echo "<td colspan='4'>Tidak ada pasien</td>";
                                    echo "</tr>";
                                }
                            ?>
                            </table>
                            <?php
                            if(mysqli_num_rows($q) > 0){
                                echo "<a class='view-all-pasien' href='viewpasien_operator.php' >view all</a>";
                            }
                            ?>
                        </div>
                    </div>

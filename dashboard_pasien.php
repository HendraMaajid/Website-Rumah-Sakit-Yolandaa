                ...
                <div class="kotak-biodata">
                    <p class="sub-judul">
                        ...
                        <?php if ($_SESSION['role'] == 'pasien') {
                         echo "<a href='editpasien1.php?id=$row[no_rekam_medis]'><span><button>Update Data</button></span></a>";
                        }
                        ?>
                    </p>
                    <div class="kotak-biodata-atas">
                     ...
                     <div class="kotak-biodata-bawah">
                        <div class="kotak-data-bawah-kiri">
                            ...
                            <tr>
                                ...
                                $s = "SELECT dokter.nama_dokter, pasien.nama_pasien, konsultasi.*
                                      ...
                                      JOIN pasien ON konsultasi.no_rekam_medis = pasien.no_rekam_medis WHERE pasien.no_rekam_medis = '$row[no_rekam_medis]'
                                      AND konsultasi.tgl_konsultasi <= '$now' ORDER BY konsultasi.tgl_konsultasi DESC";
                            ...
                            <a class="view-all-keluhan" href="viewriwayat.php" >view all</a>
                        </div>
                        <div class="kotak-data-bawah-kanan">
                            ...
                            <?php 
                                ...
                                $s = "SELECT dokter.nama_dokter, pasien.nama_pasien, konsultasi.*
                                      FROM konsultasi JOIN dokter ON konsultasi.id_dokter = dokter.id_dokter
                                      JOIN pasien ON konsultasi.no_rekam_medis = pasien.no_rekam_medis WHERE pasien.no_rekam_medis = '$row[no_rekam_medis]'
                                      AND konsultasi.tgl_konsultasi >= '$now' AND konsultasi.jam_konsultasi >= '$time'";
                            ...
                            <?php
                                if(mysqli_num_rows($q1) > 0){
                                    echo "<a class='view-all-keluhan' href='viewkonsultasi.php' >view all</a>";
                                }
                            ?>
